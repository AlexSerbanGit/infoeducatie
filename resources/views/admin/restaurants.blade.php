...
<!-- Modal -->
<div class="modal fade" id="banUser{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        @if($user->banned == 0)
          Esti sigur ca doresti sa banezi utilizatorul {{$user->name}}?
        @else
          Esti sigur ca doresti sa opresti banul utilizatorului {{$user->name}}?
        @endif
      </div>
      <div class="modal-footer">
